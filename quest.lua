...
function CodexQuest:AddQuestLogIntegration()
    ...
    CodexQuest.buttonShow:SetText(CodexText["loc"].Text_Quest_Show)
    ...
    CodexQuest.buttonHide:SetText(CodexText["loc"].Text_Quest_Hide)
    ...
    CodexQuest.buttonReset:SetText(CodexText["loc"].Text_Quest_Reset)
